...
# consider to use partial function to rewrite this part
def get(path):
    '''
...
def get_required_kw_args(fn):
    ...
    for name, param in params.items():
        # if fn has a keyword argument and its default value is empty
...
# Checks if there is an argument named 'parameter' which is the last one
def has_request_arg(fn):
    ...
    for name, param in params.items():
        ...
        if found and (
            ...
            # True means param is positional argument and this parameter is behind the request.
...
class RequestHandler(object):
    ...
    async def __call__(self, request):
        ...
        if kw is None:
            ...
            # when the function has no keyword argument, remove all arguments expect keyword argument
